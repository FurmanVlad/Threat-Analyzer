...
download_vt_button = tk.Button(root, text="Download VT Report", command=lambda: download_vt_report(vt_api_key_entry.get(), calculate_file_hash(file_path_entry.get())))
